...
class SheetUpdateDto { @Allow() action?: unknown; @Allow() headerRow?: unknown; @Allow() projectId?: unknown; @Allow() phaseId?: unknown; @Allow() developerId?: unknown; @Allow() locationId?: unknown; @Allow() defaultCurrency?: unknown; @Allow() defaultUnitType?: unknown; @Allow() defaultIsResale?: unknown; @Allow() defaultStatus?: unknown; }
...
class ProjectValueMappingDto { @IsString() @IsNotEmpty() sourceValue!: string; @IsString() @IsNotEmpty() projectId!: string; @IsString() @IsNotEmpty() phaseId!: string; }
...
export class ImportsController {
  ...
  @Get(":id/sheets/:sheetId/project-values") projectValues(@Param("id") id: string, @Param("sheetId") sheetId: string) { return this.imports.getProjectValues(id, sheetId); }
  @Patch(":id/sheets/:sheetId/project-values") mapProjectValue(@Param("id") id: string, @Param("sheetId") sheetId: string, @Body() body: ProjectValueMappingDto) { return this.imports.mapProjectValue(id, sheetId, body.sourceValue, body.projectId, body.phaseId); }
