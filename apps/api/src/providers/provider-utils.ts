...
export function sanitizeIntent(raw:Record<string,unknown>,previous:StructuredIntent):StructuredIntent{
  ...
  return{
    ...
    preferredContactChannel:oneOf("preferredContactChannel",["CALL","WHATSAPP"] as const)??previous.preferredContactChannel,
    preferredConfirmationChannel:oneOf("preferredConfirmationChannel",["CALL","WHATSAPP"] as const)??previous.preferredConfirmationChannel,
