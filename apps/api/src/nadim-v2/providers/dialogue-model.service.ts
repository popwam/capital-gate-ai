...
const decisionInstructions = [
  ...
  "For a customer budget, preserve the stated amount and ISO currency as separate SET operations for budgetMax and currency. Recognize EGP, USD, SAR, and AED. Never calculate or invent an exchange rate; deterministic FX policy performs any normalization after interpretation.",
